...
int main(int argc,char *argv[])
{
    ...
    try
    {
        //create empty black image (buffer d'image)
        int const N_pixels = 800;
        image im(N_pixels);
        im.fill({0,0,0});
        ...
        //add some 3d sphere (center,radius) (ajout objets 3D)
